...
export default function HealthCheck() {
  ...
  return(
    <Page title="Health Checkup | MineCare">
		            ...
		            <Card sx={{ p: 3 }}>
		              ...
		              {isSearched ? <TableContainer sx={{ minWidth: 800, mt:5 }}>
		                <Table>
		                  ...
		                  <TableBody>
		                        <TableRow>
		                          <TableCell align="left"><Link to="/health/checkup/Navnit Bhaktwarti/note">"Navnit Bhaktwarti"</Link></TableCell>
		                          <TableCell align="left">"121212121"</TableCell>
		                          <TableCell align="left">"Drilling"</TableCell>
		                        </TableRow>
		                        <TableRow>
		                          <TableCell align="left"><Link to="/health/checkup/note">"Navnit Bhaktwarti"</Link></TableCell>
